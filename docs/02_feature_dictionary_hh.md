...
- `no_english/unknown` означает отсутствие явного требования; ~8% строк не позволяют восстановить уровень, поэтому доли по уровню английского могут быть смещены.
...
- `edu_technical`
- `edu_math_or_cs`
- `unknown`/отсутствие метки в `edu_*` означает, что требование не указано работодателем (≈8% строк) и выводы по долям образования могут быть смещены.
